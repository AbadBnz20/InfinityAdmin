...
export const EmailTemplate = ({fullName}:Props) => {
  return (
    ...
    <p>
      ¡Nos complace darte la bienvenida a <strong>Infinity Luxury Travel Club</strong>! A partir de hoy, tienes acceso exclusivo a un nuevo producto, nuestra plataforma <strong>“INFINITY”</strong> diseñada para brindarte experiencias únicas y beneficios inigualables en hoteles, yates de lujo, cruceros y transportación de primer nivel.
    </p>
    <p>
    ...
    <ol>
      <li>Ingresa a <a href="[URL de la plataforma]">[URL de la plataforma]</a>.</li>
    ...
    <p>
      Si necesitas asistencia o tienes alguna duda, nuestro equipo de atención al socio está disponible para apoyarte en todo momento. Escríbenos a <strong>[Correo de Soporte]</strong> o contáctanos al <strong>[Teléfono de Atención]</strong>.
    </p>
    <p>
    ...
    <p>Atentamente,</p>
    <p>
      <strong>[Nombre de la plataforma]</strong><br />
      <a href="mailto:[Correo electrónico de contacto]">[Correo electrónico de contacto]</a><br />
