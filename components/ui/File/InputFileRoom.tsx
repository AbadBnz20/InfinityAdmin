...
interface Props {
    control: Control<StateFormRoom>;
    errors?: FieldErrors<StateFormRoom>;
    watch: UseFormWatch<StateFormRoom>;
    isRequired: boolean;
  }

export const InputFileRoom = ({ control, errors, isRequired }: Props) => {
