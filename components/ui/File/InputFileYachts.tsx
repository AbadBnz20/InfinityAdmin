...
interface Props {
  control: Control<StateFormPackageYachts>;
  errors?: FieldErrors<StateFormPackageYachts>;
  watch: UseFormWatch<StateFormPackageYachts>;
  isRequired: boolean;
}
export const InputFileYachts = ({ control, errors, isRequired }: Props) => {
