...
import { DeleteDepartment } from '@/actions/departaments.action';
          ...
          <div className="flex items-center gap-4">
            {update && (
              <Tooltip content="Editar" color="primary">
                <button
                  onClick={() => {
                    onChanseItem(item.IdDepartment);
                    onOpen();
                  }}
                >
            ...
            {
                  deletecell && <ModalConfirm idItem={item.IdDepartment} Ondelete={DeleteDepartment} />
                }
          </div>
        );
      default:
    ...
    <div className=" w-full flex flex-col gap-4">
      ...
      >
        ...
        <TableBody items={items}>
          {(item) => (
            <TableRow key={item.IdDepartment}>
              {(columnKey) => (
