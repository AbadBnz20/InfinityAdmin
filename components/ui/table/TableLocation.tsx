...
import { DeleteLocation } from "@/actions/location.action";
...
export const columns = [
  ...
  { name: "Codigo Postal", uid: "codePostal" },
  { name: "RFC", uid: "rfc" },
...
export const TableLocation = ({
  ...
  const renderCell = useCallback((item: Location, columnKey: React.Key) => {
    switch (columnKey) {
      case "name":
        return (
          <div>
